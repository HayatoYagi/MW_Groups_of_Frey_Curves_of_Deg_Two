...
\begin{abstract}
    ...
    In order to prove that the generic rank is exactly $1$, we calculate the characteristic polynomial of the action of the Frobenius automorphism on the second $l$-adic \'etale cohomology group to get the tight upper bound of the rank of the \Neron-Severi group.
\end{abstract}
\end{document}