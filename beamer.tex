...
\title{
    On the Mordell-Weil groups of elliptic surfaces \\
    associated with Frey curves of degree two
}
\author{八木 颯仁}
...
\begin{frame}{楕円曲線とは}
    ...
    \end{equation*}
    と書ける。ここで $r$ は\color{blue}\textbf{ランク}\color{black}、$E(K)_{\mathrm{tors}}$ は\color{blue}\textbf{捩れ部分群}\color{black}である。
\end{frame}
